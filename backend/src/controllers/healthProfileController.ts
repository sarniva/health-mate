...
import { HealthProfile, calculateBMI, getBMICategory } from "../models/HealthProfile";
...
class HealthProfileController {
  ...
  createProfile = asyncHandler(
    async (req: Request, res: Response) => {
      ...
      sendSuccessResponse(res, 201, profile, "Health profile created successfully");
    }
  );
  ...
  updateProfile = asyncHandler(
    async (req: Request, res: Response) => {
      ...
      sendSuccessResponse(res, 200, profile, "Health profile updated successfully");
    }
  );
